...
import com.github.reoseah.catwalksinc.block.CatwalkBlock.PaintedCatwalkBlock;
...
//		if (direction == right)
	...
	public boolean shouldHaveHandrail(BlockState state, WorldAccess world, BlockPos pos, Direction direction,
									  Side side) {
	...
	public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
		if (!(newState.getBlock() instanceof CatwalkStairsBlock)) {
	...
	public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
		return new ItemStack(CIncItems.CATWALK);
	}
	...
	public static class PaintedCatwalkStairsBlock extends CatwalkStairsBlock implements PaintScrapableBlock {
		...
		public PaintedCatwalkStairsBlock(DyeColor color, Settings settings) {
			super(settings);
			this.color = color;
		...
		public void scrapPaint(BlockState state, WorldAccess world, BlockPos pos) {
			BlockState uncolored = CIncBlocks.CATWALK_STAIRS.getDefaultState() //
					.with(FACING, state.get(FACING)) //
					.with(RIGHT_RAIL, state.get(RIGHT_RAIL)) //
					.with(LEFT_RAIL, state.get(LEFT_RAIL)) //
					.with(WATERLOGGED, state.get(WATERLOGGED));

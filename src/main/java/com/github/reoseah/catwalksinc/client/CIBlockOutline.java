...
public final class CIBlockOutline implements BlockOutline {
	public static final Vec3d[] FACE_ORIGIN = { //
			new Vec3d(0, 0, 0), //
			new Vec3d(0, 1, 1), //
			new Vec3d(1, 0, 0), //
			new Vec3d(0, 0, 1), //
			new Vec3d(0, 0, 0), //
			new Vec3d(1, 0, 1), };
	public static final Vec3d[] FACE_UP = { //
			new Vec3d(0, 0, 1), //
			new Vec3d(0, 0, -1), //
			new Vec3d(0, 1, 0), //
			new Vec3d(0, 1, 0), //
			new Vec3d(0, 1, 0), //
			new Vec3d(0, 1, 0), };
	public static final Vec3d[] FACE_RIGHT = { //
			new Vec3d(1, 0, 0), //
			new Vec3d(1, 0, 0), //
			new Vec3d(-1, 0, 0), //
			new Vec3d(1, 0, 0), //
	...
	public boolean onBlockOutline(WorldRenderContext wrc, BlockOutlineContext boc) {
		...
		if (MinecraftClient.getInstance().player.getMainHandStack().getItem() == CIItems.WRENCH //

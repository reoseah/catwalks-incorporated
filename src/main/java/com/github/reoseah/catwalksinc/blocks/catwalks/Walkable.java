 ...
 * have a handrail at the side touching this block, and possible causing
 * catwalks to transform into stairs shape.
 */
public interface Walkable {
	 ...
	 */
	boolean shouldDisableHandrail(BlockState state, BlockView world, BlockPos pos, Direction side);
}
